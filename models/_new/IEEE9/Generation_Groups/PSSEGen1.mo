...
equation
  ...
  connect(iEEET1_1.EFD, gENSAL.EFD)
    annotation (Line(points={{-2,0},{0,0},{0,-10},{7,-10}}, color={0,0,127}));
  connect(gENSAL.XADIFD, iEEET1_1.XADIFD) annotation (Line(points={{64.5,-18},{
          72,-18},{72,-38},{-8,-38},{-8,-19.8}}, color={0,0,127}));
  annotation (
