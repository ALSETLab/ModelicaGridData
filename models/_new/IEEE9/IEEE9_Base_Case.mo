...
model IEEE9_Base_Case
  ...
  OpenIPSL.Electrical.Buses.Bus B9(
    ...
    V_b=230000) annotation (Placement(transformation(extent={{78,82},{94,98}})));
  ...
  OpenIPSL.Electrical.Buses.Bus B6(
    ...
    V_b=230000) annotation (Placement(transformation(
        extent={{-9,-9},{9,9}},
        rotation=90,
        origin={75,19})));
  ...
  OpenIPSL.Electrical.Buses.Bus B8(
    ...
    V_b=230000) annotation (Placement(transformation(extent={{-8,82},{8,98}})));
  ...
  OpenIPSL.Electrical.Branches.PSSE.TwoWindingTransformer
    ...
    VB2=230000,
    VNOM1=16500,
    VNOM2=230000) annotation (Placement(transformation(
        extent={{-6,-4},{6,4}},
        rotation=90,
        origin={0,-68})));
  ...
  IEEE9.PF_Data.Power_Flow pf(redeclare record PowerFlow = PF_Data.PF_00000 (
        redeclare record Bus = IEEE9.PF_Data.Bus_Data.PF_Bus_00000,
        redeclare record Loads = IEEE9.PF_Data.Loads_Data.PF_Loads_00000,
        redeclare record Machines =
            IEEE9.PF_Data.Machines_Data.PF_Machines_00000,
        redeclare record Trafos = IEEE9.PF_Data.Trafos_Data.PF_Trafos_00000))
...
equation
  ...
  connect(B9.p, twoWindingTransformer.n)
    annotation (Line(points={{86,90},{101.4,90}},
                                                color={0,0,255}));
  ...
  connect(twoWindingTransformer.p, B3.p)
    annotation (Line(points={{114.6,90},{128,90}},
                                                 color={0,0,255}));
  ...
  connect(twoWindingTransformer2.n, B4.p)
    annotation (Line(points={{0,-61.4},{1,-61.4},{1,-47}},
                                                       color={0,0,255}));
  ...
  connect(twoWindingTransformer2.p, B1.p)
    annotation (Line(points={{0,-74.6},{0,-89},{1,-89}},
                                                       color={0,0,255}));
    annotation (Placement(transformation(extent={{-160,112},{-140,132}})),
