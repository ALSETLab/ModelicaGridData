...
model Gen4_AVR
  ...
  OpenIPSL.Electrical.Machines.PSSE.GENROU gENSAL(
    ...
    Tpq0=0.4,
    M_b=350000000)
             annotation (Placement(transformation(extent={{4,-18},{44,18}})));
...
equation
  ...
  connect(eSDC1A.EFD, gENSAL.EFD) annotation (Line(points={{1.6,-9},{1.6,-9},{0,
          -9},{0,-9}},                   color={0,0,127}));
  connect(eSDC1A.EFD0, gENSAL.EFD0) annotation (Line(points={{-33.6,-11.8},{
          -33.6,-22},{50,-22},{50,-9},{46,-9}},             color={0,0,127}));
  connect(const.y, eSDC1A.VUEL) annotation (Line(points={{-53.6,6},{-44,6},{-44,
          -16.7},{-22.4,-16.7}},      color={0,0,127}));
  connect(eSDC1A.VOEL, eSDC1A.VUEL) annotation (Line(points={{-16,-16.7},{-44,
          -16.7},{-44,-16.7},{-22.4,-16.7}},            color={0,0,127}));
  connect(eSDC1A.VOTHSG, eSDC1A.VUEL) annotation (Line(points={{-33.6,-6.2},{
          -44,-6.2},{-44,-16.7},{-22.4,-16.7}},        color={0,0,127}));
  connect(gENSAL.ETERM, eSDC1A.ECOMP) annotation (Line(points={{46,-5.4},{52,
          -5.4},{52,-24},{-38,-24},{-38,-9},{-33.6,-9}},      color={0,0,127}));
  annotation (
