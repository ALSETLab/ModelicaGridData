...
equation
  ...
  connect(g2.EFD, eSDC1A.EFD)
    annotation (Line(points={{2,-9},{0,-9},{0,-9},{-2.3,-9}},
                                                      color={0,0,127}));
  connect(eSDC1A.EFD0, g2.EFD0) annotation (Line(points={{-39.7,-12.6},{-39.7,
          -24},{56,-24},{56,-9},{48,-9}},         color={0,0,127}));
  connect(const.y, eSDC1A.VUEL) annotation (Line(points={{-47.6,8},{-42,8},{-42,
          -18.9},{-27.8,-18.9}},      color={0,0,127}));
  connect(eSDC1A.VOEL, eSDC1A.VUEL) annotation (Line(points={{-21,-18.9},{-42,
          -18.9},{-42,-18.9},{-27.8,-18.9}},            color={0,0,127}));
  connect(eSDC1A.VOTHSG, eSDC1A.VUEL) annotation (Line(points={{-39.7,-5.4},{
          -42,-5.4},{-42,-18.9},{-27.8,-18.9}},        color={0,0,127}));
  connect(g2.ETERM, eSDC1A.ECOMP) annotation (Line(points={{48,-5.4},{58,-5.4},
          {58,-26},{-40,-26},{-40,-9},{-39.7,-9}},        color={0,0,127}));
  annotation (
