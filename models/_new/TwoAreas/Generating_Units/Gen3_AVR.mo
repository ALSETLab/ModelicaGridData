...
equation
  ...
  connect(g3.p, pwPin) annotation (Line(points={{44,2},{46.5,2},{46.5,0},{110,0}},
               color={0,0,255}));
  connect(sEXS.EFD, g3.EFD) annotation (Line(points={{1.9,-8},{6,-8},{6,-8},{
          8.8,-8}},           color={0,0,127}));
  connect(sEXS.VOEL, const.y) annotation (Line(points={{-19,-16.8},{-52,-16.8},
          {-52,7},{-59.7,7}},color={0,0,127}));
  connect(sEXS.EFD0, g3.EFD0) annotation (Line(points={{-39.9,-11.2},{-44,-11.2},
          {-44,-24},{50,-24},{50,-8},{45.6,-8}},    color={0,0,127}));
  connect(sEXS.VUEL, const.y) annotation (Line(points={{-26.6,-16.8},{-52,-16.8},
          {-52,7},{-59.7,7}},color={0,0,127}));
  connect(sEXS.VOTHSG, const.y) annotation (Line(points={{-39.9,-4.8},{-52,-4.8},
          {-52,7},{-59.7,7}}, color={0,0,127}));
  connect(g3.ETERM, sEXS.ECOMP) annotation (Line(points={{45.6,-4},{52,-4},{52,
          -26},{-46,-26},{-46,-8},{-39.9,-8}},           color={0,0,127}));
  annotation (
